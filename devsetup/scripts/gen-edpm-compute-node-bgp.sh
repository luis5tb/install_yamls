...
EDPM_COMPUTE_VCPUS=${EDPM_COMPUTE_VCPUS:-8}
EDPM_COMPUTE_RAM=${EDPM_COMPUTE_RAM:-24}
EDPM_COMPUTE_DISK_SIZE=${EDPM_COMPUTE_DISK_SIZE:-60}
...
#nmcli device modify eth1 ipv4.addresses 100.65.$[i+1].6/30 ipv4.dns 192.168.122.1 ipv4.method manual
#nmcli device modify eth2 ipv4.addresses 100.64.0.6/30 ipv4.method manual
...
#echo IPADDR=100.65.$[i+1].6 >> /etc/sysconfig/network-scripts/ifcfg-eth1
#echo PREFIX=30 >> /etc/sysconfig/network-scripts/ifcfg-eth1
...
#sed -i /PERSISTENT_DHCLIENT/d /etc/sysconfig/network-scripts/ifcfg-eth1

#echo IPADDR=100.64.0.6 >> /etc/sysconfig/network-scripts/ifcfg-eth2
#echo PREFIX=30 >> /etc/sysconfig/network-scripts/ifcfg-eth2
#sed -i s/dhcp/none/g /etc/sysconfig/network-scripts/ifcfg-eth2
#sed -i /PERSISTENT_DHCLIENT/d /etc/sysconfig/network-scripts/ifcfg-eth2
